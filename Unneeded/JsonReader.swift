...
//    }
//    
//    // альтернатива - пример для использования в CoreDataManager
////    func importJson(_ url: URL) {
////        do {
////            let jsonData = try Data(contentsOf: url)
////            let decoder = JSONDecoder()
////            decoder.userInfo[.context] = context // понятно, что контекста здесь нет, это пример
////            let items = try decoder.decode([Artist].self, from: jsonData)
////            try context.save()
